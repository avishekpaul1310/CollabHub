...
:: Start Celery Beat
start cmd /k "title Celery Beat && cd /d C:\Users\Avishek Paul\CollabHub && venv_new\Scripts\activate && celery -A collabhub beat -l info"

:: Start Daphne Server (replacing Django dev server)
start cmd /k "title Daphne Server && cd /d C:\Users\Avishek Paul\CollabHub && venv_new\Scripts\activate && daphne -p 8000 collabhub.asgi:application"
